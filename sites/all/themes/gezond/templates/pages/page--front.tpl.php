...
<div class="outer-wrapper">
  ...
  <header id="site-header" class="site-header">
    <div class="site-hd-top">
      <div class="container">
        <?php print render($page['top_social']); ?>
        <div class="site-top-menu align-right site-menu">
          <?php print render($page['top_navigation']); ?>
        </div>
      </div>
    </div>
    <div class="site-hd-middle">
      <div class="container">
        <div class="logo">
          <?php if ($logo): ?>
